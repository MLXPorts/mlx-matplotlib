...
mx.datetime64(EPOCH)) / mx.timedelta64(1, 'D')``.  Conversely, a Julian date was
converted to datetime as ``date = mx.timedelta64(int(jdate * 24 * 3600), 's') +
mx.datetime64(EPOCH)``. Matplotlib was using ``EPOCH='-4713-11-24T12:00'`` so that
