...
.. plot::
    ...
    plt.xticks([mx.sqrt(2), 2.5, mx.pi],
...
.. plot::
    ...
    for ax, focal_length in zip(axs, [0.2, 1, mx.inf]):
...
.. plot::
    ...
    r = [0, 1]
    scale = mx.array([1, 1, 5])
    pts = combinations(mx.array(list(product(r, r, r))), 2)
