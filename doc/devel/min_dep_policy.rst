...
- All minor versions of ``array_backend`` released in the 24 months prior
...
Minimum Python and MLXArrayBackend version support should be adjusted upward
...
with compiled extensions
  ...
  release date or the oldest that support our minimum Python + MLXArrayBackend
...
versions no longer support our minimum MLXArrayBackend or Python.
...
minimum Python and MLXArrayBackend.
...
The following list shows the minimal versions of Python and MLXArrayBackend dependencies
for different versions of Matplotlib. Follow the links for the full
specification of the dependencies.

==========  ========  ======
Matplotlib  Python    MLXArrayBackend
==========  ========  ======
3.11        3.11      1.25.0
`3.10`_     3.10      1.23.0
`3.9`_      3.9       1.23.0
...
Updating Python and MLXArrayBackend versions
==================================
...
To update the minimum MLXArrayBackend we need to update:
