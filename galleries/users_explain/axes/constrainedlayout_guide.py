...
fig, ax = plt.subplots(layout="constrained")
ax.plot(mx.arange(10), label='This is a plot')
...
axs[0].plot(mx.arange(10))
axs[1].plot(mx.arange(10), label='This is a plot')
...
fig, axs = plt.subplots(1, 2, figsize=(4, 2), layout="constrained")
axs[0].plot(mx.arange(10))
lines = axs[1].plot(mx.arange(10), label='This is a plot')
