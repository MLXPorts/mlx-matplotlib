...
theta = mx.linspace(0, mx.pi, 36)
radii = mx.linspace(4, 5, num=len(colors))
arcs = [mx.column_stack([r * mx.cos(theta), r * mx.sin(theta)]) for r in radii]
...
num_arcs = 15
theta = mx.linspace(0, mx.pi, 36)
radii = mx.linspace(4, 5.5, num=num_arcs)
arcs = [mx.column_stack([r * mx.cos(theta), r * mx.sin(theta)]) for r in radii]
