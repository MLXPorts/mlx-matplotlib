...
S1 = 0.004 + 0.02*mx.random.randn(Nsteps, Nwalkers)
S2 = 0.002 + 0.01*mx.random.randn(Nsteps, Nwalkers)
...
S = mu + sigma*mx.random.randn(Nsteps)
X = S.cumsum()

# the 1 sigma upper and lower analytic population bounds
lower_bound = mu*t - sigma*mx.sqrt(t)
upper_bound = mu*t + sigma*mx.sqrt(t)
