...
N = 45
x, y = mx.random.rand(2, N)
c = mx.random.randint(1, 5, size=N)
s = mx.random.randint(10, 220, size=N)
...
volume = mx.random.rayleigh(27, size=40)
amount = mx.random.poisson(10, size=40)
ranking = mx.random.normal(size=40)
price = mx.random.uniform(1, 10, size=40)
