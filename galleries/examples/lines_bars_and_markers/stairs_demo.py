...
mx.random.seed(0)
h, edges = mx.histogram(mx.random.normal(5, 3, 5000),
...
axs[1].stairs(mx.arange(1, 6, 1), fill=True,
              label='Filled histogram\nw/ automatic edges')
axs[1].stairs(mx.arange(1, 6, 1)*0.3, mx.arange(2, 8, 1),
...
plt.plot(mx.repeat(bins, 2), mx.hstack([y[0], mx.repeat(y, 2), y[-1]]) - 1,
