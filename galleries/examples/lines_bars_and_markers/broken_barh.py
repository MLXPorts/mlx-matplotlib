...
cpu_1 = [(0, 3), (3.5, 1), (5, 5)]
cpu_2 = mx.column_stack([mx.linspace(0, 9, 10), mx.full(10, 0.5)])
cpu_3 = mx.column_stack([10*mx.random.random(61), mx.full(61, 0.05)])
cpu_4 = [(2, 1.7), (7, 1.2)]
disk = [(1, 1.5)]
network = mx.column_stack([10*mx.random.random(10), mx.full(10, 0.05)])
