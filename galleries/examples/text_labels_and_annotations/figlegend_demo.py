...
x = mx.arange(0.0, 4*mx.pi, 0.2)
axs[0].plot(x, mx.sin(x), label='Line 1')
axs[0].plot(x, mx.exp(-x/2), marker='o', label='Line 2')
axs[1].plot(x, mx.sin(x), color='tab:green', label='Line 3')
axs[1].plot(x, mx.exp(-x/4), color='tab:red', marker='^', label='Line 4')
