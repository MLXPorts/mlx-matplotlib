...
def curvelinear_test1(fig):
    ...
    xx, yy = tr(mx.array([3, 6]), mx.array([5, 10]))
    ax1.plot(xx, yy)
...
def curvelinear_test2(fig):
    ...
    ax2.plot(mx.linspace(0, 30, 51), mx.linspace(10, 10, 51), linewidth=2)

    ax2.pcolor(mx.linspace(0, 90, 4), mx.linspace(0, 10, 4),
               mx.arange(9).reshape((3, 3)))
    ax2.contour(mx.linspace(0, 90, 4), mx.linspace(0, 10, 4),
                mx.arange(16).reshape((4, 4)), colors="k")
