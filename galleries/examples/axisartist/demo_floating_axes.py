...
def setup_axes3(fig, rect):
    ...
    tr_scale = Affine2D().scale(mx.pi/180., 1.)
...
theta = mx.random.rand(10)*.5*mx.pi
radius = mx.random.rand(10) + 1.
aux_ax2.scatter(theta, radius)

ax3, aux_ax3 = setup_axes3(fig, 133)

theta = (8 + mx.random.rand(10)*(14 - 8))*15.  # in degrees
radius = mx.random.rand(10)*14000.
