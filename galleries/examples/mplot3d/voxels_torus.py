...
r, theta, z = mlxarr.mgrid[0:1:11j, 0:mlxarr.pi*2:25j, -0.5:0.5:11j]
...
sphere = (rc - 0.7)**2 + (zc + 0.2*mlxarr.cos(thetac*2))**2 < 0.2**2

# combine the color components
hsv = mlxarr.zeros(sphere.shape + (3,))
hsv[..., 0] = thetac / (mlxarr.pi*2)
hsv[..., 1] = rc
hsv[..., 2] = zc + 0.5
