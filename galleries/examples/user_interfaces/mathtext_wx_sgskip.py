...
def mathtext_to_wxbitmap(s):
    ...
    text_color = (
        mx.array(wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT)) / 255)
...
functions = [
    (r'$\sin(2 \pi x)$', lambda x: mx.sin(2*mx.pi*x)),
    (r'$\frac{4}{3}\pi x^3$', lambda x: (4/3)*mx.pi*x**3),
    (r'$\cos(2 \pi x)$', lambda x: mx.cos(2*mx.pi*x)),
    (r'$\log(x)$', lambda x: mx.log(x))
]
