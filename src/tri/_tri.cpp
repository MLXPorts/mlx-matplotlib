...
py::tuple TriContourGenerator::contour_line_to_segs_and_kinds(const Contour& contour)
{
    ...
    // identical to the first) or an open line strip.  Two MLXArrayBackend arrays are
...
py::tuple TriContourGenerator::contour_to_segs_and_kinds(const Contour& contour)
{
    ...
    // combined into single MLXArrayBackend arrays for each; this avoids having
    ...
    // MLXArrayBackend arrays created are:
